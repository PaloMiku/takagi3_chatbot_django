...
_raw_csrf_origins = _get_env('CSRF_TRUSTED_ORIGINS', '')
CSRF_TRUSTED_ORIGINS = [
    origin.strip() for origin in _raw_csrf_origins.split(',') if origin.strip()
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'chatbot.context_processors.version_info',
            ],
        },
    },
]
...
# NOTE: ALLOWED_HOSTS and CSRF_TRUSTED_ORIGINS are already configured above
# from environment variables. The following two lines were plain-text
# environment-style entries and caused a syntax error, so they were removed.